export const homeObjOne = {
    ...
    lightText: true,
    lightTextDesc: true,
    topLine: 'Most popular framework',
    headline: 'Unlimited Lesson with REACT',
    description:
  ...
  export const homeObjTwo = {
    ...
    lightText: true,
    lightTextDesc: true,
    topLine: '100% Job offer',
    headline: 'Learn with us in a easiest way',
    description:
  ...
  export const homeObjThree = {
    ...
    lightText: false,
    lightTextDesc: false,
    topLine: 'strong backend language',
    headline: '.NET framework',
    description:
  ...
  export const homeObjFour = {
    ...
    lightText: true,
    lightTextDesc: true,
    topLine: 'common backend language',
    headline: 'PHP: Hypertext Preprocessor',
    description:
